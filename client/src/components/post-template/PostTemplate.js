...
import Carousel from "./Carousel";      // 사진
...
function PostTemplate({
    ...
    const [modalOpen, setModalOpen] = useState(false);  // 모달 관리 (더보기 메뉴)
        ...
        <div className="mt-4 bg-white">
            ...
            <div className="px-2 mb-2 flex justify-between items-center">
                ...
                <div className="mt-2 px-2">
                    <div className="flex">
                        {liked ? unlikeButton : likeButton}                 {/* 좋아요 버튼 */}

                        <Link to={`/p/${id}/comments`} className="ml-2">    {/* 댓글 링크 */}
                            <svg 
                            className="w-6"
                            xmlns="http://www.w3.org/2000/svg" 
                            viewBox="0 0 512 512"
